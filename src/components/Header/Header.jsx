    ...
    return (
      <div className="App">
        <header className="container mx-auto mt-[40px] xl:px-4 2xl:px-0">
          ...
          <div className="flex justify-center items-center gap-[40px] rounded-full mt-[32px] mx-auto xl:w-[75%] h-[58px] bg-[#FAFAFA] 2xl:w-[65%]">
            <NavLink to="/" className="font-custom text-[24px] font-[700] hover:text-[#25B679]" style={getLinkStyle(0)} onClick={() => handleNavLinkClick(0)}>Monitoring</NavLink>
