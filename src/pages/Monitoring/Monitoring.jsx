...
function Monitoring() {
    return(
        <div className="container mx-auto mt-[24px] text-[#212121]">
            <h1 className="font-[700] text-[28px] line-height-[130%] font-custom">Monitoring</h1>
            <div className="px-12 py-[20px] rounded-[18px] mt-[24px] bg-[#FAFAFA]">
